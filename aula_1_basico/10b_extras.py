...
def main(page: ft.Page):
    ...
    def build_task_row(t: dict, atualizar_lista) -> ft.Container:
    ...
    def view_lista() -> ft.View:
        ...
        campo_busca = ft.TextField(
            label="Pesquise...",
            width=340,
            on_change=lambda e: filtrar_tarefas(),
        )
        ...
        def filtrar_tarefas():
            ...
            tarefas_visiveis = sorted(tasks, key=lambda t: weight_priority[t["priority"]])
            if termo:
                tarefas_visiveis = [
            ...
            contador.value = f"{completos} de {len(tasks)} tarefas concluídas"

            for t in tarefas_visiveis:
                lista_view.controls.append(build_task_row(t, filtrar_tarefas))
